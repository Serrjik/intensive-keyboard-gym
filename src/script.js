...
function createParty (text) {
	...
	const party = {
		...
		// Процент ошибок.
		// errorPercent: 0,
		// Количество ошибок в текущем тексте.
		errorCounter: 0,
		// Количество напечатанных символов в текущей партии тренировки.
		commonCounter: 0,
	}
...
function press (letter) {
	...
	if (letter === mustLetter) {
		...
		if (string.length <= party.currentPressedIndex) {
			...
			*/
			...
			// Запомнить время полного набора всех строк.
	...
	*/
	...
	// Увеличить счётчик напечатанных символов в текущей партии тренировки.
	party.commonCounter++
